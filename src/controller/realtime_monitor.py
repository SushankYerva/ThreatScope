...
class RealTimeMonitor:
    ...
    def __init__(
        ...
        self.sniffer = PacketSniffer(iface=iface, capture_filter="tcp or udp")
    ...
    def run_once(self, max_packets: int = 1000) -> List[Dict[str, Any]]:
        """
        Pull up to max_packets packets from sniffer
        ...
        # flush remaining flows at the end of this cycle
